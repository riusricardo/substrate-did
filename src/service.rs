...
use identitychain_runtime::{self, GenesisConfig, opaque::Block, RuntimeApi};
...
native_executor_instance!(
	...
	include_bytes!("../runtime/wasm/target/wasm32-unknown-unknown/release/identitychain_runtime_wasm.compact.wasm")
);
